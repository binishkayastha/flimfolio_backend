...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    user: "shasmitbasnet606@gmail.com", // Replace with your email address
    pass: "aoec mlnt qxcr tqiv", // Replace with your email password
  },
});
...
const requestPasswordReset = async (req, res, next) => {
  ...
  try {
    ...
    const mailOptions = {
      from: "shasmitbasnetwork@gmail.com",
      to: email,
